    ...
    <section id="services" class="ui container space">
        ...
        <div class="ui stackable grid">
            <div class="eight wide column centered">
                <div class="header">
                    <img :src="require(`@/assets/images/unique.png`)" alt="Unique approach"/>
            ...
            <div class="eight wide column centered">
                <div class="header">
                    <img :src="require(`@/assets/images/bandwidth.png`)" alt="Unique approach"/>
        ...
        <div class="ui stackable grid">
            <div class="eight wide column centered">
                <div class="header">
                    <img :src="require(`@/assets/images/control.png`)" alt="Unique approach"/>
